...
public class WebServicoMapper {
	...
	public Servico toModel(ServicoForm form) {
		...
		model.setQuantidadeHoras(form.getQuantidadeHoras());
		model.setPercentagemComissao(form.getPercentagemComissao());
	...
	public ServicoForm toForm(Servico model) {
		...
		form.setQuantidadeHoras(model.getQuantidadeHoras());
		form.setPercentagemComissao(model.getPercentagemComissao());
